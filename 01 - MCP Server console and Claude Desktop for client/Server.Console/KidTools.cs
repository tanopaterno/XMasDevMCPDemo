...
namespace Server.Console
{
	...
	public static class KidTools
	{
		...
		public static async Task<string> PostKid(
			...
			[Description("The date of birthday of kid")] DateTime? dateOfBirthday,
			[Description("The required toy of kid")] string toy)
		{
			...
			return string.Join("\n--\n",
				$"""
                Message: "Kid {response.Name} {response.Surname}, date of birthday {response.DateOfBirthday}, required toy {response.Toy}, successful created."
                """
			);
		}
			...
			[Description("The required toy of kid")] string toy)
		{
			...
			return string.Join("\n--\n",
				$"""
                Message: "Kid {response.Name} {response.Surname}, date of birthday {response.DateOfBirthday}, required toy {response.Toy}, successful updated."
                """
			);
		}
	}
